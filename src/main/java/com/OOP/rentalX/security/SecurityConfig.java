    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/driver/register", "/driver/login").permitAll()
                        // Public Read Endpoints (browsing vehicles and reviews)
                        .requestMatchers(HttpMethod.GET, "/vehicles/**", "/reviews/**").permitAll()
                        // Any other endpoint is accessible (or enforced via method security)
